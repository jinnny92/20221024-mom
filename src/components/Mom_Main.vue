<template>
  <div class="bg">
      ...
      <ul class="">
        <div class="">
          <div class="" style="opacity: 1; width: 1036px">
            ...
            >
              <div>
                <li class="slide01" style="width: 100%; display: inline-block">
                  <div class="txt">
                    <h1 class="title">
                      <span>당신이 생각하는</span>
                    ...
                    <h2 class="subtitle">
                      <span>이번 경기 중</span>
                      <span
                        >대중들의 사랑을 가장 많이 받은 가수를 선정하여
                        시상하는</span
                      >
                      <span
                        >한류의 대표 어워즈, 제31회 하이원 서울가요대상!</span
                      >
    ...
    <matchDay />
    <allTeamComponents @isShowData="comeIsShowData" />
    <weeklyTeamComponents />
  </div>
</template>

<script>
import headerComponents from "../components/HeaderHe.vue";
...
export default {
  ...
  methods: {
    comeIsShowData(data) {
      this.showData = data;
      console.log("get Child Data : ", this.showData);
    },
  },
};
</script>
...
.img {
  flex: 0 0 500px;
  height: 400px;
  background: url("../assets/Logo/Pick Your Best Player2.png") no-repeat center
    center;
